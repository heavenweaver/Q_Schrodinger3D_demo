...
Fz=5e6;                 %% Electric field [V/m] in the z-direction
...
Nx=32;                  %% Meshing point in x-direction
Ny=32;                  %% Meshing point in y-direction
...
if PWE_Method==1
    ...
    NGx = 17;%Nx/2-1  ;    % number of harmonics % must be at least 2 times -1 smaller than Nz (smaller => faster)
    NGy = 17;%Ny/2-1  ;    % number of harmonics % must be at least 2 times -1 smaller than Nz (smaller => faster)
